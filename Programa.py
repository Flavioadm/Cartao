                    ...
                    if (escolha == 1):
                        ...
                        if (tipo_exclusao == 1):
                            ...
                            if (numero_excluir in visa):
                                ...
                                print("Tem certeza que deseja excluir o cartão Visa número ", numero_excluir, " o cartão está cadastrado na posição: ", posicao + 1)
                                ...
                                print("Não existe cartão com esse número, favor repetir a operação ")
                                funcoes.pausar()
                            ...
                            if posicao in range (len(visa)):
                                print("Tem certeza que deseja excluir o cartão Visa número ", visa[posicao], " o cartão está cadastrado na posição: ", posicao + 1)
                                ...
                                print("Não existe a posição ", posicao + 1, " no cartão escolhido, a maior posição é a posição ", (len(visa)) + 1 )
                                funcoes.pausar()
                        
                        elif(tipo_exclusao == 3):
                            print("Tem certeza que deseja excluir todos os cartões Visa? ")
...
#******************************************* Inicio da função de consulta de exlusão de Master******************************************                                
                        ...
                        if (tipo_exclusao == 1):
                            ...
                            if (numero_excluir in master):
                                ...
                                print("Tem certeza que deseja excluir o cartão Master número ", numero_excluir, " o cartão está cadastrado na posição: ", posicao + 1)
                                confirmacao = input("Digite Sim ou Não ")
                            ...
                            if posicao in range (len(master)):
                                print("Tem certeza que deseja excluir o cartão Master número ", master[posicao], " o cartão está cadastrado na posição: ", posicao + 1)
                                ...
                                print("Não existe a posição ", posicao + 1, " no cartão escolhido, a maior posição é a posição ", (len(master)) + 1 )
                                funcoes.pausar()

                        elif(tipo_exclusao == 3):
                            print("Tem certeza que deseja excluir todos os cartões Master? ")
...
#******************************************* Inicio da função de consulta de exlusão de Elo****************************************** 
                        ...
                        if (tipo_exclusao == 1):
                            ...
                            numero_excluir = int(input("Informe o número do cartão Elo a ser excluido. \n\n"))

                            if (numero_excluir in elo):

                                posicao = elo.index(numero_excluir)

                                print("Tem certeza que deseja excluir o cartão Elo número ", numero_excluir, " o cartão está cadastrado na posição: ", posicao + 1)
                                confirmacao = input("Digite Sim ou Não ")
                            ...
                            posicao = int(input("Qual a posição do cartão Elo? \n"))

                            posicao = posicao - 1
                            
                            if posicao in range (len(elo)):
                                print("Tem certeza que deseja excluir o cartão Elo número ", elo[posicao], " o cartão está cadastrado na posição: ", posicao + 1)
                                ...
                                print("Não existe a posição ", posicao + 1, " no cartão escolhido, a maior posição é a posição ", (len(elo)) + 1 )
                                funcoes.pausar()

                        elif(tipo_exclusao == 3):
                            print("Tem certeza que deseja excluir todos os cartões Elo? ")
...
#******************************************* Inicio da função de consulta de exlusão de Outros******************************************                    
                        ...
                        if (tipo_exclusao == 1):
                            ...
                            numero_excluir = int(input("Informe o número do cartão a ser excluido. \n\n"))

                            if (numero_excluir in outros_numero):

                                posicao = outros_numero.index(numero_excluir)

                                print("Tem certeza que deseja excluir o cartão ", nome_cartao[posicao], "número ", numero_excluir, " o cartão está cadastrado na posição: ", posicao + 1)
                                confirmacao = input("Digite Sim ou Não ")
                            ...
                            print("Tem certeza que deseja excluir todos os cartões? ")
                            confirmacao = input("Digite Sim ou Não ")
...
#******************************************* Inicio da função de substituição de cartões***************************************************** 
                    ...
                    if (escolha == 1):
                        ...
                        tipo_substituicao = int(input("Informe sua escolha \n\n"))
                        
                        if (tipo_substituicao == 1):

                            numero_substituir = int(input("Informe o número do cartão visa a ser substituido. \n\n"))
                            novo_cartao = int(input("Informe o novo número do cartão "))

                            if (numero_substituir in visa):

                                posicao = visa.index(numero_substituir)

                                print("Tem certeza que deseja substituir o cartão Visa número ", numero_substituir, " por cartão visa número ", novo_cartao, "o cartão está cadastrado na posição: ", posicao + 1)
                                confirmacao = input("Digite Sim ou Não ")
                            ...
                            if posicao in range (len(visa)):
                                print("Tem certeza que deseja substituir o cartão Visa número ", visa[posicao], " o cartão está cadastrado na posição: ", posicao + 1)
...
#******************************************* Inicio da função de consulta de substituição de Master******************************************                                
                        ...
                        tipo_substituicao = int(input("Informe o sua escolha \n\n"))
                        
                        if (tipo_substituicao == 1):

                            numero_substituir = int(input("Informe o número do cartão Master a ser substituido. \n\n"))
                            novo_cartao = int(input("Informe o novo número do cartão "))
                            ...
                            if (numero_substituir in master):
                                ...
                                print("Tem certeza que deseja substituir o cartão Master número ", numero_substituir, " por cartão Master número ", novo_cartao, "o cartão está cadastrado na posição: ", posicao + 1)
                                confirmacao = input("Digite Sim ou Não ")
                            ...
                            if posicao in range (len(master)):
                                print("Tem certeza que deseja substituir o cartão Visa número ", master[posicao], " o cartão está cadastrado na posição: ", posicao + 1)
...
#******************************************* Inicio da função de consulta de substituição de Elo****************************************** 
                        ...
                        if (tipo_substituicao == 1):
                            ...
                            numero_substituir = int(input("Informe o número do cartão a ser substituido. \n\n"))
                            
                            if (numero_substituir in elo):
                                
                                nome_novo_cartao = input("Informe o nome do novo cartão \n\n")
                                novo_cartao = int(input("Informe o novo número do cartão \n\n"))
                                posicao = elo.index(numero_substituir)

                                print("Tem certeza que deseja substituir o cartão Elo número ", numero_substituir, " por cartão Elo número ", novo_cartao, "o cartão está cadastrado na posição: ", posicao + 1)
                                confirmacao = input("Digite Sim ou Não ")
                            ...
                            if posicao in range (len(elo)):
                                print("Tem certeza que deseja substituir o cartão Visa número ", elo[posicao], " o cartão está cadastrado na posição: ", posicao + 1)
...
#******************************************* Inicio da função de consulta de substituição de Outros******************************************                    
                        ...
                        if (tipo_substituicao == 1):
                            ...
                            if (numero_substituir in outros_numero):
                                ...
                                posicao = outros_numero.index(numero_substituir)

                                print("Tem certeza que deseja substituir o cartão ", nome_cartao[posicao], "número ", numero_substituir, " o cartão está cadastrado na posição: ", posicao + 1)
                                confirmacao = input("Digite Sim ou Não ")
                                    
                                if(confirmacao.upper() == "SIM"):
                                    novo_nome_cartao = input("Informe o nome do novo cartão \n\n")
                                    novo_numero_cartao = int(input("Informe o novo número do cartão \n\n"))
                            ...
                            posicao = int(input("Qual a posição do cartão ? \n"))
